...
INSERT INTO EMPLOYEE (EMPLOYEE_ID, EMPLOYEE_NAME, BIRTHDATE, GENDER, MARITAL_STATUS, LEVEL_ID, DEPARTMENT_ID, JOIN_DATE, POSITION_ID, PASSWORD, EMAIL, PHONE) VALUES ('00000001', 'Aung Aung', TO_DATE('17/12/1993', 'DD/MM/YYYY'), 'M', 'S', 1, 2, TO_DATE('17/01/2018', 'DD/MM/YYYY'), 3, '12345678','test1@gmail.com', '09421322345');

INSERT INTO EMPLOYEE (EMPLOYEE_ID, EMPLOYEE_NAME, BIRTHDATE, GENDER, MARITAL_STATUS, LEVEL_ID, DEPARTMENT_ID, JOIN_DATE, POSITION_ID, PASSWORD, EMAIL, PHONE) VALUES ('00000002', 'Hla Hla', TO_DATE('17/12/1994', 'DD/MM/YYYY'), 'F', 'S', 2, 1, TO_DATE('17/01/2019', 'DD/MM/YYYY'), 3, '12345678', 'test2@gmail.com', '09421322342');

INSERT INTO EMPLOYEE (EMPLOYEE_ID, EMPLOYEE_NAME, BIRTHDATE, GENDER, MARITAL_STATUS, LEVEL_ID, DEPARTMENT_ID, JOIN_DATE, POSITION_ID, PASSWORD, EMAIL, PHONE) VALUES ('00000003', 'Mg Soe', TO_DATE('17/12/1990', 'DD/MM/YYYY'), 'M', 'M', 4, 3, TO_DATE('17/01/2017', 'DD/MM/YYYY'), 3, '12345678', 'test3@gmail.com', '09421322555');
